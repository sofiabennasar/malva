  ...
  return (
    <>
      ...
      <section className="home-hero-section" style={{ background: 'var(--linen)', padding: '40px 72px 72px' }}>
        <div className="home-hero-card" style={{ background: 'var(--bone)', display: 'flex', flexDirection: 'column', padding: '60px 60px 0' }}>

          <HeroGallery />

          <div className="home-hero-bar" style={{ display: 'grid', gridTemplateColumns: '200px 1fr', minHeight: 150, marginTop: 16 }}>
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '28px 32px', fontFamily: 'var(--font-fraunces)', fontWeight: 300, letterSpacing: '0.02em', color: 'var(--ink)', lineHeight: 0.6 }}>
            ...
            <div className="home-hero-bar-right" style={{ padding: '28px 36px', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 12, alignItems: 'flex-end' }}>
              <h1 style={{ fontFamily: 'var(--font-dm-sans)', fontSize: 'clamp(17px, 1.6vw, 24px)', fontWeight: 300, lineHeight: 1.25, color: 'var(--ink)', textAlign: 'right' }}>
