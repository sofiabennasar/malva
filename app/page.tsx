    ...
    <>
      ...
      <section style={{ background: 'var(--moss)', padding: '0 72px 72px' }} id="story">
        <div className="values-grid" style={{ background: 'var(--linen)', display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gridTemplateRows: 'repeat(3, 260px)' }}>
          ...
          <div style={{ gridColumn: 2, gridRow: 1, padding: '36px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
          ...
          <div style={{ gridColumn: 2, gridRow: 3, padding: '36px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
