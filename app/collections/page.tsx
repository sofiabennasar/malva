...
const products: Product[] = [
  ...
  { id: 'c-6-1', name: 'SCARF 001', material: 'Llama Fiber', size: '16–18" × 79"', description: 'A lightweight scarf handwoven from undyed llama fiber on manual tension looms. Warm brown, ivory, and deep charcoal tones form a graphic color-blocked composition, finished with contrasting fringed edges. The palette comes entirely from the fiber\'s natural color variation, without synthetic dyes or chemical treatments.', madeBy: 'Romina', madeIn: 'San Juan, Argentina', care: 'Clean small areas with cold water and a mild soap. For a full wash, gently hand wash without rubbing, twisting, or wringing. Remove excess water by pressing the piece between clean towels. Reshape and dry flat in a ventilated space away from direct heat or sunlight. Do not bleach, tumble dry, or iron. Some initial shedding is normal with natural wool and should not be pulled by hand. For pieces incorporating recycled plastic or silk, avoid friction, sharp objects, and rough surfaces that may snag or pull the woven structure. Keep away from direct heat, as high temperatures may distort the recycled plastic and weaken the silk fibers. Do not iron, steam, or hang for extended periods.', image: '/c-6-1.jpg' },
