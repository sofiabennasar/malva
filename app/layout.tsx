        ...
        <footer style={{ background: 'var(--linen)', borderTop: '1px solid var(--sand)', display: 'flex', flexDirection: 'column' }}>
          <div style={{ padding: '20px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 32 }}>
              ...
              <Link href="/products" style={{ fontFamily: 'var(--font-mono)', fontSize: 20, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink)', opacity: 0.65, textDecoration: 'none' }}>Products</Link>
              <Link href="/thejournal" style={{ fontFamily: 'var(--font-mono)', fontSize: 20, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink)', opacity: 0.65, textDecoration: 'none' }}>The Journal</Link>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 32 }}>
              <Link href="/contact" style={{ fontFamily: 'var(--font-mono)', fontSize: 20, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink)', opacity: 0.65, textDecoration: 'none' }}>Contact</Link>
              <a href="https://www.instagram.com/estudio.malva?igsh=NTc4MTIwNjQ2YQ==" target="_blank" rel="noopener noreferrer" style={{ fontFamily: 'var(--font-mono)', fontSize: 20, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink)', opacity: 0.65, textDecoration: 'none' }}>Instagram</a>
            </div>
          </div>
