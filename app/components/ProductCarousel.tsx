...
export default function ProductCarousel({ slides, containerStyle, isPortrait }: { slides: Slide[]; containerStyle?: React.CSSProperties; isPortrait?: boolean }) {
  ...
  return (
    <div className="card-photo-h" style={{ ...baseStyle, ...containerStyle }}>
      {slides.map((slide, i) => (
        <img
          key={i}
          src={slide.src}
