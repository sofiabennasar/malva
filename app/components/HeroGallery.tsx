  ...
  return (
    <div className="hero-gallery" style={{ display: 'flex', justifyContent: 'flex-end', height: '66vh', minHeight: 400, width: '100%', alignItems: 'center' }}>
      ...
      <div style={{ height: '66vh', width: '70vw', background: 'var(--sand)', position: 'relative', overflow: 'hidden' }}>
        ...
        <img src="/hero-3.jpg" alt="" style={{ position: 'absolute', top: '50%', left: '50%', width: '66vh', height: '70vw', objectFit: 'cover', objectPosition: 'center 60%', display: 'block', opacity: active === 1 ? 1 : 0, transition: 'opacity 1.4s ease', transform: 'translate(-50%, -50%) rotate(-90deg)' }} />
      </div>
    </div>
  );
}
