  ...
  return (
    <div className="hero-gallery" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 4, height: '66vh', minHeight: 400, alignItems: 'end' }}>
      ...
      <div className="hero-gallery-secondary" style={{ height: '75%', background: 'var(--bone)', position: 'relative', overflow: 'hidden' }}>
        <img src="/hero-2.jpg" alt="" style={{ position: 'absolute', top: '50%', left: '50%', width: '50vh', height: '35vw', objectFit: 'cover', objectPosition: 'center', display: 'block', opacity: active === 0 ? 1 : 0, transition: 'opacity 1.4s ease', transform: 'translate(-50%, -50%) rotate(90deg)' }} />
